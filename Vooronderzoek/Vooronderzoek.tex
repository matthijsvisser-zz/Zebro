...
\setlength\itemsep{0em}
    ...
    \item Cost aware
    \item Robust - Able to withstand client or connection
...
Wireless local area networks (WLANs) or IEEE 802.11 or popularly known as Wi-Fi.\cite{wirelessmeshnetworksopportunitiesandchallenges}
