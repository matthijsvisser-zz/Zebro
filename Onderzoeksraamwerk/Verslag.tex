...
\begin{itemize}
\item Can move according to the principle of the ZebRo
\item Ability to self- charging / recharging of energy
\item Shows signs of intelligence
\item Scalable swarm population
\item Is aware when the robot is upside down
\item The robots must be modular
\end{itemize}
