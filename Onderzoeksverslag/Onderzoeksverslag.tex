...
\begin{figure}[H]
   \centering
   \includegraphics[width=.3\textwidth]{populationupdate.pdf}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=.5\textwidth]{status.pdf}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=.2\textwidth]{getid.pdf}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=.6\textwidth]{idset.pdf}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=.8\textwidth]{sender.pdf}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=.6\textwidth]{receiver.pdf}
