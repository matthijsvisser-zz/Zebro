...
\lstinputlisting[firstline=1,lastline=41,label=code:fillpop,caption= function that fills the population list.]{./code/fillpop.c}
...
\lstinputlisting[firstline=1,lastline=10,label=code:order,caption= Determines which node is the sender.]{./code/order.c}
...
\lstinputlisting[firstline=1,lastline=26,label=code:sender,caption= function when the module is the sender in the network.]{./code/sender.c}
...
\lstinputlisting[firstline=1,lastline=21,label=code:receiver,caption= function when te module is the receiver in the network.]{./code/receiver.c}
