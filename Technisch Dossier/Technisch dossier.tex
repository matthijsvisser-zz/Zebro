...
However after several tests and tweaks this method seems to be very unreliable in area's where there is some environmental noise. While testing this method we came to the conclusion that the results that were presented by the test-unit were too inconsistent. And therefore discarded this method.
