...
As stated earlier an short range localization will be implemented using acoustic wave signals. Doing so the sensor will be implemented using microphones and a actuator will be implemented using a speaker. 
